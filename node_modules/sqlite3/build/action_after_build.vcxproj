...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{F4675424-9AFB-EF4D-6F8E-17FCC1A3807C}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;..\lib\binding&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;..\lib\binding\node_sqlite3.node&quot;</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to ./lib/binding/node_sqlite3.node</Message>
      <Outputs>..\lib\binding\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{7F7A8DF0-56F7-2A83-5430-E275647063AD}</Project>
